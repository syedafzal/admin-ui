...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /* harmony import */
    var _search_pipe__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__( /*! ./search.pipe */"./src/app/search.pipe.ts");
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(dataservice, pipe) {
      ...
      _createClass(AppComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.dataservice.getData().subscribe(function (response) {
            _this.data = response;
            _this.dataSource = _toConsumableArray(response); // copy of user array
            _this.displayedColumns = ["select", "name", "email", "role", "action"];
            _this.totalItem = response.length;
            _this.paginate(_this.currentPage);
          });
        }
      }, {
        key: "searchChange",
        value: function searchChange(value) {
        ...
        value: function paginate() {
          ...
          this.endIndex = currentPage * this.perPage - 1 < this.totalItem ? currentPage * this.perPage - 1 : this.totalItem - 1;
          this.dataSource = this.dataSource.slice(this.startIndex, this.endIndex + 1);
          this.updateSelected();
        }
      }, {
        key: "setAllSelected",
        value: function setAllSelected(checked) {
          this.allSelected = checked;
          this.dataSource.forEach(function (user) {
            user.isSelected = checked;
          });
        }
      }, {
        key: "someSelected",
        value: function someSelected() {
          var ret = false;
          if (!this.allSelected) this.dataSource.forEach(function (user) {
            if (user.isSelected) {
              ret = true;
              return;
            }
        ...
        value: function update() {
          if (this.userPlaceHolder) {
            var id = this.getUser(this.userPlaceHolder.id);
        ...
        value: function edit(user) {
          if (this.userPlaceHolder) return false;
        ...
        value: function deleteSelection() {
          var _this2 = this;
          this.dataSource.forEach(function (user) {
            if (user.isSelected) _this2["delete"](user.id);
          });
        }
      }, {
        key: "delete",
        ...
        value: function getUser(id) {
          ...
          id = 1 * id;
          var ret = this.dataservice.binarySearch(this.data, 0, this.data.length - 1, id);
          return ret;
        }
      }]);
      return AppComponent;
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /* harmony import */
    var _angular_material_table__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__( /*! @angular/material/table */"./node_modules/@angular/material/esm2015/table.js");
    /* harmony import */
    ...
    /* harmony import */
    var _angular_material_input__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__( /*! @angular/material/input */"./node_modules/@angular/material/esm2015/input.js");
    /* harmony import */
    var _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__( /*! @angular/material/checkbox */"./node_modules/@angular/material/esm2015/checkbox.js");
    /* harmony import */
    ...
    /* harmony import */
    var _angular_material_button__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__( /*! @angular/material/button */"./node_modules/@angular/material/esm2015/button.js");
    /* harmony import */
    var _angular_material_button_toggle__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__( /*! @angular/material/button-toggle */"./node_modules/@angular/material/esm2015/button-toggle.js");
    /* harmony import */
    var _search_pipe__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__( /*! ./search.pipe */"./src/app/search.pipe.ts");
    /* harmony import */
    var _data_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__( /*! ./data.service */"./src/app/data.service.ts");
    /* harmony import */
    var _angular_material_grid_list__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__( /*! @angular/material/grid-list */"./node_modules/@angular/material/esm2015/grid-list.js");
    /* harmony import */
    ...
    /* harmony import */
    var _angular_material_core__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__( /*! @angular/material/core */"./node_modules/@angular/material/esm2015/core.js");
    /* harmony import */
    var _angular_material_dialog__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__( /*! @angular/material/dialog */"./node_modules/@angular/material/esm2015/dialog.js");
    /* harmony import */
    var _angular_material_select__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__( /*! @angular/material/select */"./node_modules/@angular/material/esm2015/select.js");
    var AppModule = /*#__PURE__*/_createClass(function AppModule() {
      _classCallCheck(this, AppModule);
    });
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _search_pipe__WEBPACK_IMPORTED_MODULE_14__["SearchPipe"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_4__["BrowserAnimationsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClientModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_6__["MatTableModule"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_10__["MatCheckboxModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_8__["MatFormFieldModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_11__["MatCardModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_9__["MatInputModule"], _angular_material_button_toggle__WEBPACK_IMPORTED_MODULE_13__["MatButtonToggleModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_12__["MatButtonModule"], _angular_material_grid_list__WEBPACK_IMPORTED_MODULE_16__["MatGridListModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_17__["MatIconModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_18__["MatRippleModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_19__["MatDialogModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_20__["MatSelectModule"]],
  ...
  function srcAppDataServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DataService = /*#__PURE__*/function () {
      ...
      _createClass(DataService, [{
        ...
        key: "binarySearch",
        value: function binarySearch(users, left, right, subject) {
          subject = subject * 1;
          if (right >= left) {
            var mid = Math.floor(left + (right - left) / 2);
            if (users[mid].id * 1 == subject) return mid;
            if (users[mid].id * 1 > subject) return this.binarySearch(users, left, mid - 1, subject);
    ...
    var SearchPipe = /*#__PURE__*/function () {
      ...
      _createClass(SearchPipe, [{
        ...
        value: function transform(value) {
          if (!(arguments.length <= 1 ? undefined : arguments[1])) return value;
          var searchText = String(arguments.length <= 1 ? undefined : arguments[1]).toLowerCase();
          var result = value.filter(function (user) {
